...
with(objConversationGenerator)
{
	...
	if listNumber > 0 && Texto = "Voces..."
	{
		...
		draw_text_scribble(VisualX/2+4,VisualY/2+224+4, string(TextPending[listNumber-1]))
		
		draw_set_color(c_white)
		draw_text_scribble(VisualX/2,  VisualY/2+224  , string(TextPending[listNumber-1]))
	}
}
